...
async def get_mailbox_providers_stats(
    ...
    **This endpoint allows you to retrieve your email statistics segmented by
    recipient mailbox provider.**  **We only store up to 7 days of email
    ...
    statistics, please see our [Statistics
    ...
    Args:
        ...
        mailbox_providers:
            The mail box providers to get statistics for. You can include up to 10
            by including this parameter multiple times.
        on_behalf_of:
    ...
    [http://api.sendgrid.com/v3/mailbox_providers/stats?&mailbox_providers=%s&on_behalf_of=%s&limit=%s&offset=%s&aggregated_by=%s&start_date=%s&end_date=%s](
    http://api.sendgrid.com/v3/mailbox_providers/stats?&mailbox_providers=%s&on_behalf_of=%s&limit=%s&offset=%s&aggregated_by=%s&start_date=%s&end_date=%s)
    ...
    | --- | --- |
    """  # noqa
    url = "http://api.sendgrid.com/v3/mailbox_providers/stats"  # noqa
